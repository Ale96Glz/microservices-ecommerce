...
@EnableKafka
@Configuration
@ConditionalOnProperty(name = "catalogo.kafka.enabled", havingValue = "true")
public class KafkaConfig {

    @Bean
    ConsumerFactory<String, RestockRequestedEvent> restockRequestedConsumerFactory(
            @Value("${spring.kafka.bootstrap-servers}") String bootstrapServers
    ) {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "catalogo-service");
    ...
    @Bean
    ConcurrentKafkaListenerContainerFactory<String, RestockRequestedEvent> kafkaListenerContainerFactory(
            ConsumerFactory<String, RestockRequestedEvent> restockRequestedConsumerFactory,
            CommonErrorHandler kafkaErrorHandler
    ) {
        ConcurrentKafkaListenerContainerFactory<String, RestockRequestedEvent> factory =
                new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(restockRequestedConsumerFactory);
    ...
    ConsumerFactory<String, String> dltConsumerFactory(
        ...
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "catalogo-service-dlt");
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
